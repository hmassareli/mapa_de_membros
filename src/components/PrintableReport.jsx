      ...
      <div className="print-report">
        ...
        <table className="w-full border-collapse text-xs">
          <thead>
            <tr className="bg-[#1e3a5f] text-white">
              <th className="border border-gray-300 px-2 py-2 text-left font-semibold w-[20%]">
                Família
              </th>
              <th className="border border-gray-300 px-2 py-2 text-left font-semibold w-[35%]">
                Endereço Atualizado
              </th>
              <th className="border border-gray-300 px-2 py-2 text-left font-semibold w-[20%]">
                Telefone(s)
              </th>
              <th className="border border-gray-300 px-2 py-2 text-left font-semibold w-[25%]">
                Membros
              </th>
            </tr>
          </thead>
        ...
        {editadas.length === 0 && (
          <p className="text-center text-gray-400 py-8">
            Nenhuma família com endereço editado.
          </p>
        )}
      </div>
    </div>
